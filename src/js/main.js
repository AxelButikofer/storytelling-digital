...
parallaxContainer.addEventListener("mousemove", function (event) {
  ...
  // layer 1
  const deltaX1 =
    (-(containerCoords.width * 1.02 - containerCoords.width) * percX) / 2;
  const deltaY1 =
    (-(containerCoords.height * 1.02 - containerCoords.height) * percY) / 2;
  ...
  // layer 2
  const deltaX2 =
    (-(containerCoords.width * 1.05 - containerCoords.width) * percX) / 2;
  const deltaY2 =
    (-(containerCoords.height * 1.05 - containerCoords.height) * percY) / 2;
